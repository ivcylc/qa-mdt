...
class DDIMSampler(object):
    ...
    def p_sample_ddim(
        ...
        if unconditional_conditioning is None or unconditional_guidance_scale == 1.0:
            ...
            # import pdb; pdb.set_trace()
            unconditional_conditioning['mos'] = torch.ones(x_in.shape[0], 1) * 3
        ...
        # print(unconditional_conditioning, unconditional_guidance_scale)
        # print(model_uncond.shape, model_t.shape, model_output.shape)
        # print(x.shape, self.model.parameterization)
        # print(sqrt_one_minus_at.shape, e_t.shape, a_t.shape)
        # import pdb
        # pdb.set_trace()
